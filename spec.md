...
**Thay đổi ở 3.5** — **trang Tốc độ (FR-101).** Trần bitrate từng PID, nhịp lặp từng bảng và tốc độ cả dòng chuyển từ hằng số trong code sang `config/toc-do.yaml` sửa được trên giao diện. Trần của ETSI TS 101 211 §4.1 được ghim thành phép kiểm **chặn được**, không phải một dòng chú thích.
