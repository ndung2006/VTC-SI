...
| **FR-99** | **`eitinject` gỡ ngay chương trình vừa kết thúc; dùng `--lazy-schedule-update` để giữ hết phân đoạn ba giờ.** Đo ngày 2026-09-15: bảng ta sinh ra bắt đầu `2026-09-14 23:45` với **802** sự kiện, bản thu trên sóng bắt đầu `06:45` với **466** — tức 336 sự kiện được nạp vào nhưng **không bao giờ phát**, và `06:45` chính là chương trình đang chạy lúc thu. Nên FR-98 một mình **không đổi gì ở đầu ra**; nó là *điều kiện cần*, vì cắt ở `now` thì sự kiện của phân đoạn hiện tại chưa bao giờ được nạp và cờ lazy cũng không có gì để giữ. Hai thứ phải đi cùng nhau. **Trần không vượt qua được:** cờ này đưa tới mép phân đoạn ba giờ (`06:00`), còn Barrowa giữ từ `00:00` — TSDuck không có tuỳ chọn nào cho cả ngày, nên chênh lệch tối đa ba giờ là mức gần nhất đạt được mà vẫn dùng bộ sinh EIT của TSDuck. Đây cũng là chỗ **`eitinject` quên** (chương trình đã qua) trái ngược với chỗ nó **không bao giờ quên** (dịch vụ đã rút khỏi lịch, FR-94); hai hành vi khác nhau, đừng suy cái này ra cái kia. |
