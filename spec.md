...
| **Nhân lực** | Một người |
| **Phiên bản đặc tả** | 3.2 — 2026-09-15 |
...
| **FR-98** | **Mép đầu cửa sổ EIT là 00:00 UTC của ngày hiện tại**, không phải thời điểm hiện tại. Giữ cả chương trình đã phát xong trong ngày. Lý do không phải là bắt chước: EIT schedule sub-table 0x50 phủ *ngày 0–3*, ngày 0 bắt đầu **nửa đêm UTC** và chia thành các phân đoạn ba giờ, nên cắt ở `now` là phát ra một ngày 0 khuyết đầu. Chỗ này người xem thấy được: đầu thu cho cuộn ngược lại chương trình đã chiếu trong ngày sẽ hiện trống ở hệ này mà đầy ở hệ kia, và VTC-SI là hệ dự phòng nên phải trùng. Đo: hai bản thu Barrowa cách nhau bốn tiếng đều bắt đầu đúng `00:00:00` UTC — **không** phải nửa đêm Hà Nội (17:00 UTC). Mép cuối vẫn tính từ `now`: nó là độ sâu **còn lại về phía trước**, neo vào đầu ngày thì cửa sổ ngắn dần đi trong ngày. Giá phải trả: số sự kiện tăng khoảng 46 % (521 → 759 đo lúc 07:00 UTC), tức PID 18 từ ~80 kbps lên ~117 kbps — vẫn xa trần 400 kbps ở FR-70. |
